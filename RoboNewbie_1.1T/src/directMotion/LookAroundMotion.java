 ...
 * 
 * This motion will turn the robots head down to about 40°, back into the 
    ...
    double pitch = Math.toDegrees(percIn.getJoint(NeckPitch));
        ...
        switch(nextPose){
            ...
            case D_CENTER_L:
                ...
                // if ( Math.abs(pitch) <= 5)       // why abs?   hdb   
                if (pitch > -5) {
            ...
            case RIGHT:
                ...
                break;
            case R_CENTER_D:
                //  if ( Math.abs(yaw) <= 5 )     // why abs?    hdb  
                          // if for some reason the value is >5 then motion continues
                if (yaw >= -5) {
